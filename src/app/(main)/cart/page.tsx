...
export default function CartPage() {
  ...
  // ✅ Call all hooks before rendering
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {items.length === 0 ? (
        ...
        // Cart view with swipe-to-remove
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          {/* Order Summary */}
          <div className="lg:col-span-1 bg-white p-6 rounded-lg shadow-sm border space-y-4">
            ...
            <Button size="lg" className="w-full mt-4 rounded-full">Proceed to Checkout</Button>
